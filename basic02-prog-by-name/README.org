...
- [[#assignments][Assignments]]
  ...
  - [[#assignment-2-add-xdp_drop-program][Assignment 2: Add xdp_drop program]]
...
** Assignment 2: Add xdp_drop program

Add a new program section "xdp_drop" in [[file:xdp_prog_kern.c]] that uses
